...
git https://github.com/ksylvan/docker-mail-server.git  $ans_dms_path     
ansible-galaxy install --roles-path  $ans_dms_path/certificates 
ansible-galaxy install --roles-path  $ans_dms_path/deploy-user
ansible-galaxy install --roles-path  $ans_dms_path/docker
ansible-galaxy install --roles-path  $ans_dms_path/mailserver 
ansible-galaxy install --roles-path  $ans_dms_path/secure-server
ansible-galaxy install --roles-path  $ans_dms_path/unblock-ports 
